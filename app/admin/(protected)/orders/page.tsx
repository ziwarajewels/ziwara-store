      ...
      <div className="flex min-h-screen bg-[#F9F6F0]">
        ...
        <div className="flex-1 flex flex-col min-h-screen">
          ...
          <div className="md:hidden bg-white border-b border-[#E8E0D0] px-6 py-4 flex items-center justify-between sticky top-0 z-40">
            <h1 className="text-2xl font-bold tracking-wide text-[#2A3F35]">Orders Management</h1>
            <button
          ...
          <div className="flex-1 p-6 md:p-10">
            <h1 className="hidden md:block text-3xl md:text-4xl font-bold tracking-wide mb-8">
              Orders Management
            </h1>
              ...
              {orders.map((order) => (
                <div key={order.id} className="bg-white rounded-3xl border border-[#E8E0D0] p-6">
                  ...
                  <button 
                    ...
                    className="mt-8 w-full bg-[#2A3F35] hover:bg-[#D4AF37] text-white py-3.5 rounded-2xl text-sm font-medium transition-all"
                  >
                    View Full Details
                  </button>
                </div>
                  ...
                  {orders.map((order) => (
                    <tr key={order.id} className="border-b hover:bg-[#F9F6F0]/60">
                      ...
                      <td className="pr-6 md:pr-10 text-center">
                        <button 
                          onClick={() => openOrderDetails(order)} 
                          className="bg-[#2A3F35] hover:bg-[#D4AF37] text-white px-6 py-2.5 rounded-2xl text-sm transition-all"
                        >
                          View Details
                        </button>
                      </td>
            ...
            <div className="px-4 py-4 border-t bg-white sticky bottom-0 flex gap-4">
              {selectedOrder.status === 'PENDING_PAYMENT_CONFIRMATION' && (
                <button 
                  ...
                  className="flex-1 bg-[#2A3F35] hover:bg-green-600 text-white py-3 rounded-2xl font-medium transition-all"
                >
                  Confirm Order
                </button>
              )}
              <button 
                ...
                className="flex-1 border border-[#E8E0D0] py-4 rounded-2xl font-medium hover:bg-[#F9F6F0]"
              >
                Close
              </button>
            </div>
